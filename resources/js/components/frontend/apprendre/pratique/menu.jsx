...
function ExerciceListe({ exercices,onFetch,onFetchSolution,solutions,langages}) {
  ...
  return (
    ...
    <div  style={{width:"100%"}}>
          ...
          <h3 style={{textAlign:"center",width:"100%"}} className="titre">Liste des exercices</h3>
        ...
        <Link to={ `/entrainement/exercice/${exercice._id}` } style={{height:"27em"}} onClick={()=>{setVisible2(!visible2New)}}>
...

{
  exercices.filter(exercice=>exercice.type==langageNew ).map((exercice,index )=> {
    ...
    <Route exact path={ `/entrainement/exercice/${exercice._id}` }   >
